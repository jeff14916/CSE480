    ...
    return (
        <div className={styles.content}>
            <div>
                ...
                <div>
                    <img className={styles.cameraImg} src="https://global.canon/en/technology/structure/dslr/img/02.jpg" alt="img" />
            ...
            <div>
                ...
                <div>
                    <img className={styles.cameraImg} src="https://global.canon/en/technology/structure/mcamera/img/image01.jpg" alt="img" />
                    <p className={styles.para}>
                        {mirrorlessPara}
                   </p>
                </div>
            ...
            <div className={styles.hrTitle}>
                ...
                <div>
                    <img className={styles.cameraImg} src="https://www.filmcameraexpert.com/wp-content/uploads/2020/11/learn-film-camera-parts.jpg" alt="img" />
                    <p className={styles.para}>
                        {filmPara}
                    </p>
                </div>
